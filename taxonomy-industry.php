<?php
	...
	/**
	 * The Template for displaying Industry Categories.
	 */
...
<?php
	...
	if (empty($heading)) {
		$heading = $term->name . ' Case Studies';
	}
...
<section class="component--hero position-relative mt-5">
...
<?php
													get_template_part('case-study', 'loop');
												else :
													// 404.
